...
# Fonts
FONT_PATH_TERMINA = get_asset_path("Termina-Demi.otf")
FNT_CLR = "#000000"
FONT_SIZE_TINY = 40
FONT_SIZE_V_SML = 100
FONT_SIZE_SML = 130
FONT_SIZE_MED = 150
FONT_SIZE_BIG = 180
FONT_TINY = ImageFont.truetype(FONT_PATH_TERMINA, FONT_SIZE_TINY)
FONT_V_SML = ImageFont.truetype(FONT_PATH_TERMINA, FONT_SIZE_V_SML)
FONT_SML = ImageFont.truetype(FONT_PATH_TERMINA, FONT_SIZE_SML)
FONT_MED = ImageFont.truetype(FONT_PATH_TERMINA, FONT_SIZE_MED)
FONT_BIG = ImageFont.truetype(FONT_PATH_TERMINA, FONT_SIZE_BIG)
